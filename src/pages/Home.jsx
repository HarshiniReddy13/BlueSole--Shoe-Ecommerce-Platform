  ...
  return (
      <div className="home">
          <div className="banner1">
              <marquee className="marquee" behavior="scroll" direction="left" scrollamount="5" loop="infinite">
                  <div className="b1 b">BlueSole</div>
                  <div className="b2 b">BEST SALES ON THE ENTIRE COLLECTION</div>
                  <div className="b1 b">BlueSole</div>
                  <div className="b2 b">BEST SALES ON THE ENTIRE COLLECTION</div>
                  <div className="b1 b">BlueSole</div>
                  <div className="b2 b">BEST SALES ON THE ENTIRE COLLECTION</div>
          ...
          <div className="banner2">
              <div className="ba1"><img src="https://i.postimg.cc/nr0szZPL/backdrop1-removebg-preview.png" alt=""/></div>
              <div className="ba2">
                  <div className="bh">New Customer Offer!</div>
                  <div className="bp">Get premium sneakers starting at 20% off on your first BlueSole order!</div>
              </div>
          </div>
          <div className="banner3">
              <div className="ban1">All the shoes you need in one place</div>
              <div className="ban2">Your Perfect Pair, Just a Click Away!</div>
          </div>
          <div className="line">
          ...
          <div className="banner6">
              <div className="logos">
                  ...
                  <img src="https://culture-cirlce-static-dge7g8b8eue6fvcv.z02.azurefd.net/static/images/brand-logo/supreme.jpg" alt=""/>
              </div>
          </div>
      </div>
  );
